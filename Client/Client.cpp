...
int main(int argc, char** argv)
{
    ...
    while (true)
    {
        ...
        cout << "Please enter operation and amount (e.g., DEPOSIT 100.50): ";
        cin >> operation >> amount;

        string message = operation + " " + to_string(amount);
        ...
        if (iResult > 0) {
            cout << "Server responds: " << answer << "\n";
        }
        else if (iResult == 0)
            cout << "Connection to server closed.\n";
        else
